...
```{r point_small, include=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
## Make raster
...
```{r point_large, include=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
## Make raster
...
```{r polygon, include=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
...
```{r grid_1, include=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
...
```{r grid_2, include=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
...
```{r grid_3, include=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
## Make raster
...
```{r png_2, include=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
#### Make grid
