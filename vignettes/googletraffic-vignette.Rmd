...
```{r point_small, include=TRUE, warning=FALSE, message=FALSE, eval=F}
## Make raster
...
```{r point_large, include=TRUE, warning=FALSE, message=FALSE, eval=F}
## Make raster
...
```{r polygon, include=TRUE, warning=FALSE, message=FALSE, eval=F}
...
```{r grid_1, include=TRUE, warning=FALSE, message=FALSE, eval=F}
...
```{r grid_2, include=TRUE, warning=FALSE, message=FALSE, eval=F}
...
```{r grid_3, include=TRUE, warning=FALSE, message=FALSE, eval=F}
## Make raster
